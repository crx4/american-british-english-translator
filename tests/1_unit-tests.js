...
suite('Unit Tests', () => {
  ...
  suite('Function translate(input, fromLanguage)', () => {
    ...
    suite('American to British English', () => {
      ...
      test('Mangoes are my favorite fruit. --> Mangoes are my favourite fruit.', done => {
        ...
        assert.strictEqual(Translator.translate(input), output);

        done();
      });

      test('I ate yogurt for breakfast. --> I ate yoghurt for brekky.', done => {
    ...
    suite('British to American English', () => {
      ...
      test('We watched the footie match for a while. --> We watched the soccer match for a while.', done => {
        ...
        assert.strictEqual(Translator.translate(input, 'british'), output);
